/**
 * Test the parse-extract.js field extraction logic.
 * Simulates the n8n Code node environment with mock data.
 * Run: node packages/flows/definitions/code/test-parse-extract.js
 */

const fs = require('fs');
const path = require('path');
const code = fs.readFileSync(path.join(__dirname, 'parse-extract.js'), 'utf8');
...
function runExtraction(userText, beatrizText, leadData) {
  ...
  // In JS, $('Upsert Lead') calls $ with the node name string
